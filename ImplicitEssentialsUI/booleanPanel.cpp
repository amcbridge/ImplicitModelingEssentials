	...
	: basePanel(parent, id, pos, size)
{
	...
	mTranslateX = new wxTextCtrl(this, wxID_ANY, "0", wxDefaultPosition, wxSize(95, 25), 0, *mValidator);
	mTranslateY = new wxTextCtrl(this, wxID_ANY, "0", wxDefaultPosition, wxSize(95, 25), 0, *mValidator);
	mTranslateZ = new wxTextCtrl(this, wxID_ANY, "0", wxDefaultPosition, wxSize(95, 25), 0, *mValidator);
	translationSizer->Add(xLabel, 1, wxALIGN_CENTER_VERTICAL | wxLEFT, 5);
	translationSizer->Add(mTranslateX, 1, wxEXPAND | wxALL, 5);
	translationSizer->Add(yLabel, 1, wxALIGN_CENTER_VERTICAL | wxLEFT, 5);
	translationSizer->Add(mTranslateY, 1, wxEXPAND | wxALL, 5);
	translationSizer->Add(zLabel, 1, wxALIGN_CENTER_VERTICAL | wxLEFT, 5);
